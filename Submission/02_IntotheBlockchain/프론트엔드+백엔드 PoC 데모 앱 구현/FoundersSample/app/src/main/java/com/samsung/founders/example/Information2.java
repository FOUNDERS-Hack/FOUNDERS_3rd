                ...
                new Button.OnClickListener(){
                    public void onClick(View v){
                        ...
                        try{
                            ...
                            intent.putExtra("DATE", birthText.getText().toString());
                            intent.putExtra("GEN", checked.getText().toString());
                            intent.putExtra("JOB", jobText.getText().toString());
                            intent.putExtra("ETC", etcText.getText().toString());
